...
---------------------
Let's create a new **app_test.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **app_test.js** file.

```
node app_test.js
```

You should see the following output after running the **app_test.js** file.
