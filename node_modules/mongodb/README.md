...
---------------------
Let's create a new **angularApp.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **angularApp.js** file.

```
node angularApp.js
```

You should see the following output after running the **angularApp.js** file.
